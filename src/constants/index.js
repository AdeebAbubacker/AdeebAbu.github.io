...
const experiences = [
  {
    ...
    points: [
      ...
      "Collaborated with cross-functional teams to ensure smooth data flow between mobile interfaces and backend systems.",
      "Participated in code reviews and contributed to establishing clean, reusable code standards.",
      "Acted as a bridge between mobile and backend teams to resolve technical challenges and maintain development efficiency.",
